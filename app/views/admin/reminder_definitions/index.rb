class Views::Admin::ReminderDefinitions::Index < Views::Base
  ...
  def page_content
    ...
    div(class: "flex items-center justify-between mb-6") do
      ...
      link_to "New reminder", new_admin_user_reminder_definition_path(@user), class: "bg-blue-600 text-white px-3 py-1.5 rounded-md text-sm hover:bg-blue-700"
    end
        ...
        @reminder_definitions.each do |rd|
          div(class: "bg-white border border-gray-200 rounded-lg p-4 flex items-center justify-between") do
            ...
            div(class: "flex gap-3 text-sm") do
              ...
              button_to "Delete", admin_user_reminder_definition_path(@user, rd), method: :delete, data: {turbo_confirm: "Delete this reminder?"},
