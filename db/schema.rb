...
ActiveRecord::Schema[8.1].define(version: 2026_06_17_044735) do
  ...
  create_table "reminder_definitions", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_reminder_definitions_on_user_id"
  end
  ...
  create_table "task_definitions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_task_definitions_on_user_id"
  end
